# Generated by Django 4.0.7 on 2023-09-20 21:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('hospital', '0013_remove_bloodpurchase_unitprice'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hospital_assets', to=settings.AUTH_USER_MODEL)),
            ],
            options={
