...
urlpatterns = [
    ...
    path('edit_department/<int:pk>', views.edit_departmentView, name='edit_departmentView'),
    path('update_department/<int:pk>', views.update_departmentView, name='update_departmentView'),
    path('delete_department/<int:pk>', views.delete_departmentView, name='delete_departmentView'),
